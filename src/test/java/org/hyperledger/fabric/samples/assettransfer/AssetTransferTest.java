...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Asset asset = contract.DuplicateAsset(ctx, "asset1", "Lucifer");

            assertThat(asset).isEqualTo(new Asset("asset1_duplicate", "blue", 5, "Lucifer", 300));
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "Lucifer");
            });
